...
const DEFAULT_SITE_DATA = {
  ...
  products: [
    ...
    },
    {
      ...
      brand: "Dior Paris",
      price: "PKR 48,500",
      tag: "Best-Seller Men's Fragrance",
      image: "assets/images/Shop Inside/Perfumes.jpeg",
      description: "Crisp Calabrian bergamot, smoky Papua New Guinean vanilla extract and noble Ambroxan.",
      inStock: true
    },
    {
      id: "p18",
      ...
      brand: "Chanel Paris",
      price: "PKR 54,000",
      tag: "Woody Aromatic Scent",
      image: "assets/images/Shop Inside/Perfume_1.jpg",
      description: "An ode to male freedom in a woody aromatic fragrance with a captivating New Caledonian sandalwood trail.",
      inStock: true
    },
    {
      id: "p19",
      name: "Flormar HD Invisible Cover Foundation",
      category: "color_cosmetics",
      categoryName: "Color Cosmetics & Makeup",
      brand: "Flormar Europe",
      price: "PKR 3,450",
      tag: "Smooth HD Coverage",
      image: "assets/images/Shop Inside/HDvisiblefoundation.jpg",
      description: "Lightweight, breathable liquid foundation with SPF 30 providing a naturally luminous matte finish.",
      inStock: true
    },
    {
      id: "p20",
      name: "Golden Rose Longstay Liquid Matte Lipstick",
      category: "color_cosmetics",
      categoryName: "Color Cosmetics & Makeup",
      brand: "Golden Rose Europe",
      price: "PKR 1,950",
      tag: "Transfer-Proof 16H",
      image: "assets/images/Shop Inside/GoldenRose-179.jpg",
      description: "Enriched with Vitamin E and Avocado Oil, non-drying full coverage liquid matte formula.",
      inStock: true
    },
    {
      id: "p21",
      name: "Pretty By Flormar Illuminating Primer",
      category: "color_cosmetics",
      categoryName: "Color Cosmetics & Makeup",
      brand: "Flormar Europe",
      price: "PKR 2,150",
      tag: "Luminous Base",
      image: "assets/images/Shop Inside/PRETTY-PRIMER-ILLUMINATING.jpg",
      description: "Glowing makeup base that hydrates and illuminates tired skin before foundation.",
      inStock: true
    },
    {
      id: "p22",
      name: "Golden Rose Creamy Blusher Stick No. 102",
      category: "color_cosmetics",
      categoryName: "Color Cosmetics & Makeup",
      brand: "Golden Rose Europe",
      price: "PKR 2,250",
      tag: "Dewy Multi-Stick",
      image: "assets/images/Shop Inside/blusherstick2.jpg",
      description: "Hydrating velvet blush stick with effortless blending on cheeks and lips.",
      inStock: true
    },
    {
      id: "p23",
      name: "Pampers Premium Protection Diapers Size 3 (60 Pcs)",
      category: "babycare",
      categoryName: "Baby Care & Nutrition",
      brand: "Pampers International",
      price: "PKR 4,650",
      tag: "Feather Soft & Leakproof",
      image: "assets/images/Shop Inside/BabyCare.jpeg",
      description: "Ultra-absorbent breathable core with wetness indicator for newborn to active infant comfort.",
      inStock: true
    },
    {
      id: "p24",
      name: "Mustela Gentle Cleansing Gel for Baby (500ml)",
      category: "babycare",
      categoryName: "Baby Care & Nutrition",
      brand: "Mustela France",
      price: "PKR 4,200",
      tag: "Avocado Perseose Formula",
      image: "assets/images/Shop Inside/gallery-16.jpg",
      description: "Soap-free tearless cleansing gel formulated with 93% natural ingredients for baby's sensitive skin.",
      inStock: true
    },
    {
      id: "p25",
      name: "Avent Natural Response Baby Feeding Bottle (260ml)",
      category: "babycare",
      categoryName: "Baby Care & Nutrition",
      brand: "Philips Avent",
      price: "PKR 3,850",
      tag: "Anti-Colic Valve",
      image: "assets/images/Shop Inside/gallery-10.jpg",
      description: "Works like the breast with unique opening and tip that only releases milk when baby actively drinks.",
      inStock: true
    },
    {
      id: "p26",
      name: "Sudocrem Antiseptic Healing Baby Care Cream (125g)",
      category: "babycare",
      categoryName: "Baby Care & Nutrition",
      brand: "Sudocrem UK",
      price: "PKR 2,150",
      tag: "Nappy Rash Relief",
      image: "assets/images/Shop Inside/gallery-13.jpg",
      description: "Clinically proven barrier formulation to soothe, heal and protect baby's delicate irritated skin.",
      inStock: true
    },
    {
      id: "p27",
      name: "Dr. Reckeweg R1 Inflammation & Infection Drops (50ml)",
      category: "homeo",
      categoryName: "Homeopathic Care",
      brand: "Dr. Reckeweg Germany",
      price: "PKR 1,450",
      tag: "Original German Homeopathy",
      image: "assets/images/Shop Inside/Homeo.jpeg",
      description: "Traditional German homeopathic formula for localized inflammatory infections, throat irritation and tonsillitis.",
      inStock: true
    },
    {
      id: "p28",
      name: "Schwabe Cineraria Maritima Eye Drops (10ml)",
      category: "homeo",
      categoryName: "Homeopathic Care",
      brand: "Schwabe Germany",
      price: "PKR 1,250",
      tag: "Alcohol-Free Eye Care",
      image: "assets/images/Shop Inside/gallery-15.jpg",
      description: "Natural herbal eye drops formulated for eye strain, irritation, cataract prevention, and visual fatigue.",
      inStock: true
    },
    {
      id: "p29",
      name: "Dr. Reckeweg R89 Anti-Hairloss Drops (30ml)",
      category: "homeo",
      categoryName: "Homeopathic Care",
      brand: "Dr. Reckeweg Germany",
      price: "PKR 2,850",
      tag: "Hair Root Revitalizer",
      image: "assets/images/Shop Inside/gallery-14.jpg",
      description: "Comprehensive homeopathic remedy targeting hair loss, premature graying, and scalp vitality.",
      inStock: true
    },
    {
      id: "p30",
      name: "Schwabe Biochemic Kali Phos 6X (20g)",
      category: "homeo",
      categoryName: "Homeopathic Care",
      brand: "Schwabe Germany",
      price: "PKR 980",
      tag: "Nerve Tonic Salt",
      image: "assets/images/Shop Inside/gallery-11.jpg",
      description: "Essential tissue cell salt to relieve mental exhaustion, nervous headaches, and stress fatigue.",
      inStock: true
    },
    {
      id: "p31",
      name: "Beurer HA 50 Digital Hearing Amplifier",
      category: "hearing_aid",
      categoryName: "Hearing & Diagnostics",
      brand: "Beurer Germany",
      price: "PKR 8,500",
      tag: "Ergonomic In-Ear Fit",
      image: "assets/images/Shop Inside/HearingAid.jpeg",
      description: "Discreet medical hearing amplifier with 40 dB sound gain, noise reduction, and interchangeable earplugs.",
      inStock: true
    },
    {
      id: "p32",
      ...
      price: "PKR 2,450",
      tag: "SpO2 & Pulse Monitor",
      image: "assets/images/Shop Inside/gallery-31.jpg",
      description: "High-precision fingertip pulse oximeter for real-time blood oxygen saturation and pulse rate readouts.",
      inStock: true
    },
    {
      id: "p33",
      name: "Beurer IH 18 Medical Compressor Nebulizer",
      category: "hearing_aid",
      categoryName: "Hearing & Diagnostics",
      brand: "Beurer Germany",
      price: "PKR 11,500",
      tag: "German Respiratory Care",
      image: "assets/images/Shop Inside/gallery-32.jpg",
      description: "Effective compressed-air technology for treating upper and lower respiratory tract diseases and asthma.",
      inStock: true
    },
    {
      id: "p34",
      name: "Oakley Holbrook Matte Black Prizm Sunglasses",
      category: "optics",
      categoryName: "Optics & Eyewear",
      brand: "Oakley USA",
      price: "PKR 34,500",
      tag: "Prizm Sapphire Polarized",
      image: "assets/images/Shop Inside/watches_1.jpg",
      description: "Timeless classic design accented with metal rivets and iconic Oakley icons. 100% UV filter lenses.",
      inStock: true
    },
    {
      id: "p35",
      name: "Gucci Square Frame Acetate Eyeglasses",
      category: "optics",
      categoryName: "Optics & Eyewear",
      brand: "Gucci Italy",
      price: "PKR 68,000",
      tag: "Designer Luxury Frame",
      image: "assets/images/optics.jpg",
      description: "Sophisticated Havana acetate square frame with gold-tone interlocking G logos on temples.",
      inStock: true
    },
    {
      id: "p36",
      name: "Beurer FT 65 Multi-Functional Infrared Thermometer",
      category: "surgical",
      categoryName: "Surgical & Health Devices",
      brand: "Beurer Germany",
      price: "PKR 6,950",
      tag: "6-in-1 Instant Reading",
      image: "assets/images/surgical.jpg",
      description: "Fast contactless forehead and ear temperature reading with optical high temperature fever alarm.",
      inStock: true
    },
    {
      id: "p37",
      name: "Drive Medical Foldable Lightweight Wheelchair",
      category: "surgical",
      categoryName: "Surgical & Health Devices",
      brand: "Drive Medical",
      price: "PKR 36,000",
      tag: "Heavy-Duty Mobility",
      image: "assets/images/Shop Inside/gallery-28.jpg",
      description: "Durable steel frame, swing-away footrests, comfortable nylon upholstery, and easy compact folding.",
      inStock: true
    },
    {
      id: "p38",
      name: "Ferrero Rocher Hazelnut Chocolates (24 Pcs Gift Box)",
      category: "grocery",
      categoryName: "Superstore & Grocery",
      brand: "Ferrero Italy",
      price: "PKR 3,250",
      tag: "Imported Confectionery",
      image: "assets/images/Shop Inside/Grocery.jpeg",
      description: "Whole crunchy hazelnut enveloped in velvety creamy chocolate filling and crispy wafer shell.",
      inStock: true
    },
    {
      id: "p39",
      name: "Twinings English Breakfast Tea Imported (100 Bags)",
      category: "grocery",
      categoryName: "Superstore & Grocery",
      brand: "Twinings London",
      price: "PKR 2,450",
      tag: "Rich & Robust Blend",
      image: "assets/images/grocery.jpg",
      description: "Golden and well-rounded traditional black tea crafted from the finest Kenyan and Assam tea leaves.",
      inStock: true
    },
    {
      id: "p40",
      name: "Nutella Hazelnut Cocoa Spread Imported (750g)",
      category: "grocery",
      categoryName: "Superstore & Grocery",
      brand: "Ferrero",
      price: "PKR 2,150",
      tag: "Original European Jar",
      image: "assets/images/Shop Inside/gallery-25.jpg",
      description: "Authentic imported hazelnut spread with skimmed milk and cocoa, free from artificial colors and preservatives.",
      inStock: true
    },
    {
      id: "p41",
      name: "Luminarc Opal Glass 46-Piece Dinner Set",
      category: "crockery",
      categoryName: "Crockery & Household",
      brand: "Luminarc France",
      price: "PKR 26,500",
      tag: "Thermal & Shock Resistant",
      image: "assets/images/Shop Inside/Crockery.jpeg",
      description: "Elegant 100% hygienic non-porous tempered opal glassware designed for contemporary dining tables.",
      inStock: true
    },
    {
      id: "p42",
      name: "Thermos Stainless King Vacuum Insulated Flask (1.2L)",
      category: "crockery",
      categoryName: "Crockery & Household",
      brand: "Thermos Germany",
      price: "PKR 8,900",
      tag: "24-Hour Temperature Lock",
      image: "assets/images/Shop Inside/gallery-22.jpg",
      description: "Double wall vacuum insulation for maximum hot and cold temperature retention with twist-and-pour stopper.",
      inStock: true
    },
    {
      id: "p43",
      name: "LEGO City Police Patrol Interceptor Building Set",
      category: "toys",
      categoryName: "Toys & Entertainment",
      brand: "LEGO Official",
      price: "PKR 5,450",
      tag: "Original LEGO Set",
      image: "assets/images/Shop Inside/Toys.jpeg",
      description: "High-speed police interceptor vehicle with driver minifigure, removable roof and aerodynamic styling.",
      inStock: true
    },
    {
      id: "p44",
      ...
      price: "PKR 6,800",
      tag: "Musical Learning Toy",
      image: "assets/images/Shop Inside/gallery-9.jpg",
      description: "Snuggly plush pup teaches first words, colors, body parts and alphabet with 75+ songs and sounds.",
      inStock: true
    },
    {
      id: "p45",
      name: "IFG Comfort 20 Soft Cotton Bra (Multipack)",
      category: "undergarments",
      categoryName: "Undergarments & Innerwear",
      brand: "IFG Original",
      price: "PKR 3,450",
      tag: "Breathable All-Day Fit",
      image: "assets/images/Shop Inside/IFG-COMFORT-20-BRA-ALL-COLOR.jpg",
      description: "Premium pure combed cotton everyday wire-free comfort bra with soft non-slip elasticated straps.",
      inStock: true
    },
    {
      id: "p46",
      name: "Warm Winter Ultra-Soft Thermal Innerwear Set",
      category: "undergarments",
      categoryName: "Undergarments & Innerwear",
      brand: "D. Watson Apparel",
      price: "PKR 4,500",
      tag: "Thermal Insulation",
      image: "assets/images/Shop Inside/Undergarments.jpeg",
      description: "Lightweight thermal top and bottom base layer engineered for superior cold-weather body heat retention.",
      inStock: true
    }
  ],
